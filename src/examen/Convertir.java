...
public class Convertir extends JFrame implements ActionListener{
	...
	texto.setEditable(false);
       ...
       boton = new JButton("0");
       boton.setBounds(10, 260, 50, 50);
	boton.addActionListener(this);
        add(boton);
        boton.setVisible(true);
        
        boton1 = new JButton("1");
       boton1.setBounds(10, 110, 50, 50);
	boton1.addActionListener(this);
        add(boton1);
        boton1.setVisible(true);
        
        boton2 = new JButton("2");
       boton2.setBounds(60, 110, 50, 50);
	boton2.addActionListener(this);
        add(boton2);
        boton2.setVisible(true);
        
        boton3 = new JButton("3");
       boton3.setBounds(110, 110, 50, 50);
	boton3.addActionListener(this);
        add(boton3);
        boton3.setVisible(true);
        
        boton4 = new JButton("4");
       boton4.setBounds(10, 160, 50, 50);
	boton4.addActionListener(this);
        add(boton4);
        boton4.setVisible(true);
        
        boton5 = new JButton("5");
        boton5.setBounds(60, 160, 50, 50);
        boton5.addActionListener(this);
        add(boton5);
        boton5.setVisible(true);
         
        boton6= new JButton("6");
        boton6.setBounds(110, 160, 50, 50);
        boton6.addActionListener(this);
        add(boton6);
        boton6.setVisible(true);
        
        boton7 = new JButton("7");
       boton7.setBounds(10, 210 , 50, 50);
	  boton7.addActionListener(this);
        add(boton7);
        boton7.setVisible(true);
        
        boton8 = new JButton("8");
       boton8.setBounds(60, 210, 50, 50);
	 boton8.addActionListener(this);
        add(boton8);
        boton8.setVisible(true);
        
        boton9 = new JButton("9");
       boton9.setBounds(110, 210, 50, 50);
	boton9.addActionListener(this);
        add(boton9);
        boton9.setVisible(true);
        
        operacion = new JButton(".");
       operacion.setBounds(60, 260, 50, 50);
	 operacion.addActionListener(this);
       ...
       borrar.setBounds(225, 190, 150, 50);
	borrar.addActionListener(this);
        add(borrar);
        borrar.setVisible(true);
        
        convertidor = new JButton("Convertir");
       convertidor.setBounds(225, 120, 150, 50);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        else if(e.getSource()==convertidor)
        {
            ...
            if(pp.isEmpty()){
                ...
                double resulf = resulset/17;
                JOptionPane.showMessageDialog(this, "El Equivalente a Dolares es \n"+resulf+"" );
